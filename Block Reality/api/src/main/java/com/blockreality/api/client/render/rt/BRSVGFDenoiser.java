...
public final class BRSVGFDenoiser {
    ...
    public static int denoise(int rtInputTex, int normalTex, int depthTex, int prevDepthTex,
        ...
        GL42.glBindImageTexture(0, rtInputTex, 0, false, 0, GL11.GL_READ_ONLY, GL30.GL_RGBA16F);
        GL42.glBindImageTexture(1, historyTex, 0, false, 0, GL11.GL_READ_ONLY, GL30.GL_RGBA16F);
        GL42.glBindImageTexture(2, accumTex, 0, false, 0, GL11.GL_WRITE_ONLY, GL30.GL_RGBA16F);
        ...
        for (int i = 0; i < ATROUS_ITERATIONS; i++) {
            ...
            GL42.glBindImageTexture(0, inputTex, 0, false, 0, GL11.GL_READ_ONLY, GL30.GL_RGBA16F);
            GL42.glBindImageTexture(1, outputTex, 0, false, 0, GL11.GL_WRITE_ONLY, GL30.GL_RGBA16F);
