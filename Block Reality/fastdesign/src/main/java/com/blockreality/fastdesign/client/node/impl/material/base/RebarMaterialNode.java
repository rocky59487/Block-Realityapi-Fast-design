...
/** B1-12: 鋼筋材料常數 */
@OnlyIn(Dist.CLIENT)
public class RebarMaterialNode extends BRNode {
    private static final DefaultMaterial MAT = DefaultMaterial.REBAR;

    public RebarMaterialNode() {
        super("Rebar", "鋼筋", "material", NodeColor.MATERIAL);
    ...
    @Override public String getTooltip() { return "HRB400 鋼筋材料常數"; }
    @Override public String typeId() { return "material.base.RebarMaterial"; }
}
