...
/** B1-7: 玻璃材料常數 */
public class GlassMaterialNode extends BRNode {
    private static final DefaultMaterial MAT = DefaultMaterial.GLASS;

    public GlassMaterialNode() {
        super("Glass", "玻璃", "material", NodeColor.MATERIAL);
    ...
    @Override public String getTooltip() { return "普通平板玻璃材料常數"; }
    @Override public String typeId() { return "material.base.GlassMaterial"; }
}
