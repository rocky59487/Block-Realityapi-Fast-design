...
/** B1-5: 木材材料常數 */
@OnlyIn(Dist.CLIENT)
public class TimberMaterialNode extends BRNode {
    private static final DefaultMaterial MAT = DefaultMaterial.TIMBER;

    public TimberMaterialNode() {
        super("Timber", "木材", "material", NodeColor.MATERIAL);
    ...
    @Override public String getTooltip() { return "杉木/橡木結構木材材料常數"; }
    @Override public String typeId() { return "material.base.TimberMaterial"; }
}
