...
/** B1-11: 基岩材料常數 */
@OnlyIn(Dist.CLIENT)
public class BedrockMaterialNode extends BRNode {
    private static final DefaultMaterial MAT = DefaultMaterial.BEDROCK;

    public BedrockMaterialNode() {
        super("Bedrock", "基岩", "material", NodeColor.MATERIAL);
    ...
    @Override public String getTooltip() { return "不可破壞基岩材料常數（無限強度）"; }
    @Override public String typeId() { return "material.base.BedrockMaterial"; }
}
