...
### [L1-brml — Block Reality Machine Learning Subsystem](L1-brml/index.md)

Python/JAX 基礎的機器學習管線，用於訓練物理代理模型與崩塌預測網路。

**功能大類**：代理模型訓練 · 節點推薦器 · 崩塌預測 · UI 與 ONNX 匯出

---

### [L1-libpfsf — Standalone PFSF Physics Solver](L1-libpfsf/index.md)

獨立的 C++ Vulkan 物理計算引擎函式庫，提供原生的結構分析執行環境。

**功能大類**：Vulkan 上下文管理 · 獨立緩衝區管理 · 物理求解器 (RBGS/Multigrid) · JNI 橋接
