...
| BFS 限制 | 2048 blocks / 50ms 雙煞車 | 需改為階層式區域分析 |
...
**瓶頸 2：快照建構時間**
```
SnapshotBuilder.buildSnapshot() 遍歷 ServerLevel
...
**瓶頸 4：BFS 結構分析**
```
UnionFindEngine.findUnsupportedBlocks() BFS 上限 2048
